...
JVM_OPTS="$JVM_OPTS -Djna.tmpdir={{ pillar['cassandra']['directories']['jvm_tmp_dir'] }}"
JVM_OPTS="$JVM_OPTS -Dorg.xerial.snappy.tempdir={{ pillar['cassandra']['directories']['jvm_tmp_dir'] }}"
JVM_OPTS="$JVM_OPTS -Djava.io.tmpdir={{ pillar['cassandra']['directories']['jvm_tmp_dir'] }}"
